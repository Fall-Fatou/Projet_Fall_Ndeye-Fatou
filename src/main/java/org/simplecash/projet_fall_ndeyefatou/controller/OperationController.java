...
public class OperationController {
    ...
    @GetMapping("/historique/cc/{compteId}")
    public List<OperationDto> historiqueCC(@PathVariable Long compteId) {
        return operationService.historiqueCompteCourant(compteId);
    }

    @GetMapping("/historique/ce/{compteId}")
    public List<OperationDto> historiqueCE(@PathVariable Long compteId) {
        return operationService.historiqueCompteEpargne(compteId);
    }
}
